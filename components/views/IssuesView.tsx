...
export function IssuesView({ analysisResult, reviews }: IssuesViewProps) {
  ...
  const generateIssueAnalysis = async () => {
    ...
    try {
      // Get negative reviews (rating 1-2)
      ...
      const categories: IssueCategory[] = [
        {
          ...
          icon: Bug,
          color: "text-red-400",
          reviews: negativeReviews.filter(review => 
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex items-center gap-3">
            <div className={`p-2 rounded-lg ${selectedCategory.color.replace('text-', 'bg-').replace('-400', '-500/20')}`}>
        ...
        <Card className="bg-black/30 border-zinc-800/50 backdrop-blur-sm">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-zinc-400 mb-4">
              Categorizing negative reviews and identifying common problems...
            </p>
              ...
              >
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div className={`p-3 rounded-lg ${category.color.replace('text-', 'bg-').replace('-400', '-500/20')}`}>
